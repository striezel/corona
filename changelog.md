...
The plotly.js library is updated from version 2.12.1 to version 2.18.0.
...
* update futures-channel, futures-core, futures-util to 0.3.25
* update futures-io, futures-sink, futures-task to 0.3.26
