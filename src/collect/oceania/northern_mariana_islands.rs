...
pub struct NorthernMarianaIslands
{
}

impl NorthernMarianaIslands
{
  /**
   * Returns a new instance.
   */
  pub fn new() -> NorthernMarianaIslands
  {
    NorthernMarianaIslands { }
  }
}

impl Collect for NorthernMarianaIslands
{
  /**
...
mod tests
{
  ...
  fn has_data()
  {
    let data = NorthernMarianaIslands::new().collect(&Range::Recent);
    assert!(data.is_ok());
