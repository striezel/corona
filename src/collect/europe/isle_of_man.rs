...
impl IsleOfMan
{
   ...
   */
  pub fn new() -> IsleOfMan
  {
    IsleOfMan { }
  }
}

impl Collect for IsleOfMan
{
  /**
  ...
  {
    disease_sh::request_historical_api_province("UK", "isle%20of%20man", range)
  }
}
...
mod tests
{
  ...
  fn has_data()
  {
    let data = IsleOfMan::new().collect(&Range::Recent);
    assert!(data.is_ok());
