...
[![minimum rustc 1.56.1](https://img.shields.io/badge/minimum%20rustc-1.56.1-c18170?logo=rust&style=for-the-badge)](https://www.whatrustisit.com/)

To build the application you need the Rust compiler. The Minimum Supported Rust
Version (MSRV) is Rust 1.56.1. Furthermore, you need Cargo (Rust's package
